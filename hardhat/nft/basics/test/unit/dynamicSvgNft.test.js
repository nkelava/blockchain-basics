...
!developmentChains.includes(network.name)
  ...
  : describe("Dynamic SVG NFT Unit Tests", function () {
      ...
      describe("constructor", () => {
        it("initializes staring values correctly", async () => {
      ...
      describe("mintNft", () => {
        it("emits an event, creates an NFT", async () => {
      ...
      describe("convertSvgToImageURI", () => {
        it("converts svg to image URI", async () => {
          const lowSVG = fs.readFileSync("./images/dynamicNft/frown.svg", { encoding: "utf8" });
          const lowSVGImageUri = await dynamicSvgNft.convertSvgToImageURI(lowSVG);
